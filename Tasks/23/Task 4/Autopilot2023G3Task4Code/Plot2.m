...
exportgraphics(gcf,'fig/u_de5_2.png')
% save2word('Plots_2')
...
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
exportgraphics(gcf,'fig/w_de5_2.png')
% save2word('Plots_2')
hold off 
...
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
exportgraphics(gcf,'fig/alpha_de5_2.png')
% save2word('Plots_2')
...
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
exportgraphics(gcf,'fig/q_de5_2.png')
% save2word('Plots_2')
...
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
exportgraphics(gcf,'fig/theta_de5_2.png')
% save2word('Plots_2')
...
plot(out.tout,out.Velocities(:,1),'--r','DisplayName','Non Linear')
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
exportgraphics(gcf,'fig/u_dt6000_2.png')
% save2word('Plots_2')
...
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
ylim([28 31.5])
exportgraphics(gcf,'fig/w_dt6000_2.png')
% save2word('Plots_2')
...
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
exportgraphics(gcf,'fig/alpha_dt6000_2.png')
% save2word('Plots_2')
...
plot(out.tout,out.AngularRates(:,2),'--r','DisplayName','Non Linear')
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
exportgraphics(gcf,'fig/q_dt6000_2.png')
% save2word('Plots_2')
...
plot(out.tout,out.EulerAngles(:,2)*180/pi,'--r','DisplayName','Non Linear')
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
exportgraphics(gcf,'fig/theta_dt6000_2.png')
% save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _a')
plot(out.tout,out.v_5a,'--r','DisplayName','Non Linear')
xlim([0 100])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _a')
plot(out.tout,out.beta_5a,'--r','DisplayName','Non Linear')
xlim([0 100])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _a')
plot(out.tout,out.p_5a,'--r','DisplayName','Non Linear')
xlim([0 100])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _a')
plot(out.tout,out.r_5a,'--r','DisplayName','Non Linear')
xlim([0 100])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _a')
plot(out.tout,out.phi_5a,'--r','DisplayName','Non Linear')
xlim([0 100])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _a')
plot(out.tout,unwrap(out.psi_5a),'--r','DisplayName','Non Linear')
ylim([-2000 2000])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _r')
plot(out.tout,out.v_5r,'--r','DisplayName','Non Linear')
xlim([0 50])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _r')
plot(out.tout,out.beta_5r,'--r','DisplayName','Non Linear')
xlim([0 50])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _r')
plot(out.tout,out.p_5r,'--r','DisplayName','Non Linear')
xlim([0 50])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _r')
plot(out.tout,out.r_5r,'--r','DisplayName','Non Linear')
xlim([0 50])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _r')
plot(out.tout,out.phi_5r,'--r','DisplayName','Non Linear')
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
...
hold on
title('Step Response For 5 deg. \delta _r')
plot(out.tout,unwrap(out.psi_5r),'--r','DisplayName','Non Linear')
ylim([-1000 1000])
set(findall(gcf,'type','line'),'linewidth',1.7);grid on ;legend ;
save2word('Plots_2')
%}
