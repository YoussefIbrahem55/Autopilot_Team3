...
tfinal = 200 %aircraft_data(2); % Final time
...
dc = [0 -5 0 0*180/pi]*pi/180;%[aircraft_data(57:59)* pi/180; aircraft_data(60)]; % Control surface deflections
da= dc(1);
dr= dc(2);
de= dc(3);
dth=dc(4);
...
benchmarks = load('benchmarks.mat');  
conversion=[1;1;1;1;1;180/pi;180/pi;180/pi;1;1;1;1;1;1];
benchmark=benchmarks.benchmarks.Benchmark_B747_FC5_neg_5deg_drudder.*conversion;
plotStateComparisons(time_V, states_vec_kutta, time_V, benchmark', dc)
